Text Editor created by Kareem Khalidi and John Gauchi for CSC 335 "Object Oriented Programming" at the University of Arizona.
...
4. Undo, Redo and Command: No deviation, a CommandList class is used to house the list of commands
 the book describes and add/undo/redo with it.

5. Spell checking, hyphenation, Iterator, and Visitor: No deviation, the misspelled words are shown
 in a popup window.